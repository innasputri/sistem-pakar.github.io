...
<head>
  ...
  <title>Admin | BKU Al-Manar</title>
...
<body>
  <div class="navbar navbar-inverse" role="navigation">
      <div class="navbar-header">
        <div class="logo"><h1>Dashboard - Admin Deteksi Awal Gangguan Kesehatan Mental</h1></div>
    ...
    <div class="template-page-wrapper">
      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          ...
          <a href="#" class="list-group-item active">
                    ...
                    <p class="list-group-item-text">Sistem deteksi gangguan kesehatan mental ini adalah sebuah sistem yang digunakan untuk mendeteksi awal jenis  gangguan mental. Proses deteksi dengan menentukan gejala-gejala yang terjadi pada mahasiswa, dengan menggunakan perhitungan metode dempster shafer maka sistem dapat memberikan keputusan tentang hasil diagnosa awal.</p>
                  </a>
      ...
      <footer class="templatemo-footer">
        <div class="templatemo-copyright">
          <p>Copyright &copy; 2022 | Sistem Deteksi Gangguan Kesehatan Mental | BKU Al-Manar (Dempster Shafer)</p>
        </div>
      </footer>
    </div>
