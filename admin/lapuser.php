...
<body>
  <div class="navbar navbar-inverse" role="navigation">
      <div class="navbar-header">
        <div class="logo"><h1>Dashboard - Admin Gangguan Kesehatan Mental  | Metode Dempster Shafer</h1></div>
  ...
  <button type="submit" class="btn btn-default">Simpan</button>
   ...
   ?>
                    <tr>
                      ...
                      <td><?php echo $data ['namaorangtua'];?></td>
                      <td><?php echo $data ['whatsapp'];?></td>
                      <!-- <td><?php echo $data ['gejala_terpilih'];?></td> -->
	...
	while($dataP=mysqli_fetch_array($strP)){
	 ...
	 ?></td>
                      ...
                      <!-- <td><a href="cetak-show2.php?=idpasien=<?php echo $data['idpasien'];?>" class="btn btn-link">Cetak</a></td> -->
                      <td><a href="cetak-show2.php?idpasien=<?php echo $data['idpasien'];?>" class="btn btn-link">Cetak</a></td>
                    </tr><?php }?>                    
                  </tbody>
                </table>
