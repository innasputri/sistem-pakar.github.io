...
<head>
  ...
  <title>BKU Al-MANAR | Gangguan Kesehatan Mental</title>
...
<body>
  <div class="navbar navbar-inverse" role="navigation">
      <div class="navbar-header">
        <div class="logo"><h1>Dashboard - Admin BKU Al-Manar | Gangguan Kesehatan Mental</h1></div>
...
<form id="form1" name="form1" method="post" action="simpan_kaidah_produksi.php" enctype="multipart/form-data"><div>
  ...
  ?>
		 ...
		 Belief<input type="text" name="cf" size="5"></strong></td>
  ...
  <?php } ?>
      ...
      <footer class="templatemo-footer">
        <div class="templatemo-copyright">
          <p>Copyright &copy; 2022 | Deteksi Gangguan Kesehatan Mental (Dempster Shafer)</p>
        </div>
      </footer>
    </div>
